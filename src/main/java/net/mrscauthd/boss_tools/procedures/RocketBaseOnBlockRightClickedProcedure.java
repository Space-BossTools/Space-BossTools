	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((new Object() {
			...
			if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == RocketLaunchPadBlock.block.getDefaultState()
					.getBlock())
					&& (((world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z))).getBlock() == RocketLaunchPadBlock.block
							.getDefaultState().getBlock())
							&& (((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == RocketLaunchPadBlock.block
									.getDefaultState().getBlock())
									&& (((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)))).getBlock() == RocketLaunchPadBlock.block
											.getDefaultState().getBlock())
																	...
																	&& (((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) (z + 1))))
																			...
																			&& ((world.getBlockState(
																					new BlockPos((int) (x - 1), (int) y, (int) (z - 1))))
																							.getBlock() == RocketLaunchPadBlock.block
																									.getDefaultState().getBlock())))))))))) {
				if (!world.isRemote()) {
		...
		} else if ((!((world.getBlockState(new BlockPos((int) (x - 1), (int) y, (int) z))).getBlock() == RocketLaunchPadBlock.block.getDefaultState()
				.getBlock()))) {
			if (!world.isRemote()) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
		...
		} else if ((!((world.getBlockState(new BlockPos((int) x, (int) y, (int) (z + 1)))).getBlock() == RocketLaunchPadBlock.block.getDefaultState()
				.getBlock()))) {
			if (!world.isRemote()) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
