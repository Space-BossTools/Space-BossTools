...
public class Tier2SpaceStationCreate2Procedure extends BossToolsModElements.ModElement {
	public Tier2SpaceStationCreate2Procedure(BossToolsModElements instance) {
		super(instance, 632);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BossToolsMod.LOGGER.warn("Failed to load dependency x for procedure Tier2SpaceStationCreate2!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BossToolsMod.LOGGER.warn("Failed to load dependency y for procedure Tier2SpaceStationCreate2!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BossToolsMod.LOGGER.warn("Failed to load dependency z for procedure Tier2SpaceStationCreate2!");
			return;
		}
