...
public class OpenTier3SpaceStationMenu5Procedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BossToolsMod.LOGGER.warn("Failed to load dependency entity for procedure OpenTier3SpaceStationMenu5!");
			return;
		}
		...
		entity.getPersistentData().putDouble("Tier_3_space_station_open", 5);
	}
}
