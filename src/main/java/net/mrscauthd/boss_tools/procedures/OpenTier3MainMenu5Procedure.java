...
public class OpenTier3MainMenu5Procedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BossToolsMod.LOGGER.warn("Failed to load dependency entity for procedure OpenTier3MainMenu5!");
			return;
		}
		...
		entity.getPersistentData().putDouble("Tier_3_open_main_menu_5", 1);
	}
}
