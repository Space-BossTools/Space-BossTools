	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				BossToolsMod.LOGGER.warn("Failed to load dependency sourceentity for procedure Rockethurtentity2!");
			return;
		}
		...
		if ((sourceentity.isSneaking())) {
			if ((!(entity.isBeingRidden()))) {
				...
				}.getItemStack((int) (0), entity)).getItem() == new ItemStack(ModInnet.FUELBARREL.get(), (int) (1)).getItem())) {
					{
