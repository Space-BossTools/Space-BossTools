...
public class OpenTier2SpaceStationMenu3Procedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BossToolsMod.LOGGER.warn("Failed to load dependency entity for procedure OpenTier2SpaceStationMenu3!");
			return;
		}
		...
		entity.getPersistentData().putDouble("Tier_2_space_station_open", 3);
	}
}
