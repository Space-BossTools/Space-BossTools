...
public class OpenTier3mainMenu2Procedure extends BossToolsModElements.ModElement {
	public OpenTier3mainMenu2Procedure(BossToolsModElements instance) {
		super(instance, 639);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BossToolsMod.LOGGER.warn("Failed to load dependency entity for procedure OpenTier3mainMenu2!");
			return;
		}
		...
		entity.getPersistentData().putDouble("Tier_3_open_main_menu_2", 1);
	}
}
