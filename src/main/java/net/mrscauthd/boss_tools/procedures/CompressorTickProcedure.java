...
public class CompressorTickProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
		...
		} else if (((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
		...
		} else if (((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
						TileEntity _ent = world.getTileEntity(pos);
			...
			if (((new Object() {
				...
				if (((new Object() {
				...
				}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "recipe")) == 1)) {
					{
						...
						if (_ent != null) {
							final int _sltid = (int) (2);
							final ItemStack _setstack = new ItemStack(CompressedDeshItem.block, (int) (1));
							_setstack.setCount((int) ((new Object() {
								public int getAmount(IWorld world, BlockPos pos, int sltid) {
									AtomicInteger _retval = new AtomicInteger(0);
									TileEntity _ent = world.getTileEntity(pos);
			...
			if (((new Object() {
				...
				if ((((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
					...
					if ((((new Object() {
						...
						.getTagByID(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH))).contains((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
		...
		if ((((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
				.contains((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						.getTagByID(new ResourceLocation(("forge:ingots/desh").toLowerCase(java.util.Locale.ENGLISH))).contains((new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
								if (_ent != null) {
						...
						|| (ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/silicon").toLowerCase(java.util.Locale.ENGLISH)))
								.contains((new Object() {
									public ItemStack getItemStack(BlockPos pos, int sltid) {
										AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
										TileEntity _ent = world.getTileEntity(pos);
		...
		if (((((ItemTags.getCollection().getTagByID(new ResourceLocation(("forge:ingots/steel").toLowerCase(java.util.Locale.ENGLISH)))
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(CompressedDeshItem.block, (int) (1))
						.getItem()))
												...
												|| ((ItemTags.getCollection()
														...
														&& ((new Object() {
															public ItemStack getItemStack(BlockPos pos, int sltid) {
																...
																.getItem() == new ItemStack(CompressedDeshItem.block, (int) (1))
																		.getItem()))))))) == (true))) {
			if (!world.isRemote()) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
