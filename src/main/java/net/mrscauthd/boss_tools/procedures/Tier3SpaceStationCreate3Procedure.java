...
public class Tier3SpaceStationCreate3Procedure extends BossToolsModElements.ModElement {
	public Tier3SpaceStationCreate3Procedure(BossToolsModElements instance) {
		super(instance, 651);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BossToolsMod.LOGGER.warn("Failed to load dependency x for procedure Tier3SpaceStationCreate3!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BossToolsMod.LOGGER.warn("Failed to load dependency y for procedure Tier3SpaceStationCreate3!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BossToolsMod.LOGGER.warn("Failed to load dependency z for procedure Tier3SpaceStationCreate3!");
			return;
		}
