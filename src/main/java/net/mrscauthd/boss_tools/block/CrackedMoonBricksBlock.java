...
public class CrackedMoonBricksBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:cracked_moon_bricks")
	public static final Block block = null;
	public CrackedMoonBricksBlock(BossToolsModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cracked_moon_bricks");
		}
