...
public class MooncopperOreBlock extends BossToolsModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("boss_tools:moon_desh_ore_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 9)).range(25)
					.square().func_242731_b(3);
			event.getRegistry().register(feature.setRegistryName("moon_desh_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("boss_tools:moon_desh_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
