...
public class BlockOfDeshBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:block_of_desh")
	public static final Block block = null;
	public BlockOfDeshBlock(BossToolsModElements instance) {
		super(instance, 46);
	}
