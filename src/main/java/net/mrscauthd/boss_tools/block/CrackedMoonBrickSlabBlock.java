...
public class CrackedMoonBrickSlabBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:cracked_moon_brick_slab")
	public static final Block block = null;
	public CrackedMoonBrickSlabBlock(BossToolsModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cracked_moon_brick_slab");
		}
