...
public class MarssiliconoreBlock extends BossToolsModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mars_silicon_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("boss_tools:mars_silicon_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mars_silicon_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("boss_tools:mars_silicon_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
