...
public class MoonoreironBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:moon_iron_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("boss_tools:moon_iron_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("moon_iron_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("boss_tools:moon_iron_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
