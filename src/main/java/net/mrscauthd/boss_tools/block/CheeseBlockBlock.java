...
public class CheeseBlockBlock extends BossToolsModElements.ModElement {
	@ObjectHolder("boss_tools:moon_cheese_ore")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("moon_cheese_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("boss_tools:moon_cheese_ore_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 10)).range(75)
					.square().func_242731_b(4);
			event.getRegistry().register(feature.setRegistryName("moon_cheese_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("boss_tools:moon_cheese_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
