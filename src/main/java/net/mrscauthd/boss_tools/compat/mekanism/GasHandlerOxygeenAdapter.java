...
public class GasHandlerOxygeenAdapter implements IOxygenStorage {

	private IGasHandler gasHandler;
	private boolean canExtract;
	private boolean canReceive;

	public GasHandlerOxygeenAdapter(IGasHandler gasHandler) {
		this(gasHandler, true, true);
	}

	public GasHandlerOxygeenAdapter(IGasHandler gasHandler, boolean canExtract, boolean canReceive) {
