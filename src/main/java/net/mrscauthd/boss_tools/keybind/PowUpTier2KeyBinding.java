...
import net.mrscauthd.boss_tools.procedures.PowUponkeypressProcedure;
...
public class PowUpTier2KeyBinding extends BossToolsModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.boss_tools.rocket_start_2", GLFW.GLFW_KEY_SPACE, "key.categories.spacebosstools");
