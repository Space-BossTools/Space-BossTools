...
import net.mrscauthd.boss_tools.procedures.PowUponkeypressTier3Procedure;
...
public class PowupTier3KeyBinding extends BossToolsModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.boss_tools.rocket_start_3", GLFW.GLFW_KEY_SPACE, "key.categories.spacebosstools");
