...
import net.mrscauthd.boss_tools.procedures.RotationAProcedure;
import net.mrscauthd.boss_tools.procedures.RocketRotationAOnKeyReleasedProcedure;
...
public class RocketRotationAKeyBinding extends BossToolsModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.boss_tools.rocket_rotation_a", GLFW.GLFW_KEY_A, "key.categories.spacebosstools");
