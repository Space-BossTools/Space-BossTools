...
public class OilFluid extends FlowingFluid {
    ...
    protected FluidAttributes createAttributes() {
        return net.minecraftforge.fluids.FluidAttributes.builder(
                 new ResourceLocation("boss_tools","blocks/fluid_oil_still"),
                 new ResourceLocation("boss_tools","blocks/fluid_oil_flow"))
                .overlay(new ResourceLocation("boss_tools","blocks/fluid_oil_still"))
                .translationKey("block."+ "boss_tools" +".oil")
