...
@OnlyIn(Dist.CLIENT)
public class RocketTier2Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RocketTier2Entity.entity, renderManager -> {
	...
	public static class ModelRocketTier2 extends EntityModel<Entity> {
		...
		public void setRotationAngles(Entity en, float f, float f1, float f2, float f3, float f4) {
			RocketTier2Entity.CustomEntity e = (RocketTier2Entity.CustomEntity) en;
