...
public class MoglerRenderer {
    public static class ModelRegisterHandler {
        ...
        public void registerModels(ModelRegistryEvent event) {
            RenderingRegistry.registerEntityRenderingHandler(MoglerEntity.entity, renderManager -> {
                return new MobRenderer(renderManager, new Modelmoglerium(), 0.7f) {
                    @Override
                    public ResourceLocation getEntityTexture(Entity entity) {
                        return new ResourceLocation("boss_tools:textures/moglerium.png");
                    }
                };
            });
        }
    ...
    public static class Modelmoglerium<T extends MobEntity & IFlinging> extends AgeableModel<T>  {
