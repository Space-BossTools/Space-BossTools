...
public class RoverRenderer {
	...
	public static class Modelrover extends EntityModel<Entity> {
		...
		wellfront1.setRotationPoint(18.0F, 19.0F, -44.0F);
		wellfront1.setTextureOffset(50, 28).addBox(0.0F, -5.0F, -5.0F, 6.0F, 10.0F, 10.0F, 0.0F, false);

		wellfront2 = new ModelRenderer(this);
		wellfront2.setRotationPoint(-18.0F, 19.0F, -44.0F);
		wellfront2.setTextureOffset(50, 28).addBox(-6.0F, -5.0F, -5.0F, 6.0F, 10.0F, 10.0F, 0.0F, false);
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			// Animation1
			this.wellfront1.rotateAngleX = f2 / (180F / (float) Math.PI);
			this.wellfront2.rotateAngleX = f2 / (180F / (float) Math.PI);
			this.wellback1.rotateAngleX = f2 / (180F / (float) Math.PI);
			this.wellback2.rotateAngleX = f2 / (180F / (float) Math.PI);
			if (e instanceof LivingEntity) {
				this.wellfront1.rotateAngleX = (float) ((LivingEntity) e).getPersistentData().getDouble("Wheel");
				this.wellfront2.rotateAngleX = (float) ((LivingEntity) e).getPersistentData().getDouble("Wheel");
				this.wellback1.rotateAngleX = (float) ((LivingEntity) e).getPersistentData().getDouble("Wheel");
				this.wellback2.rotateAngleX = (float) ((LivingEntity) e).getPersistentData().getDouble("Wheel");
			}
		//	this.wellfront1.rotateAngleY = f2 / (180F / (float) Math.PI);
		//	this.wellfront2.rotateAngleY = f2 / (180F / (float) Math.PI);
			if (e instanceof LivingEntity) {
			//	this.wellfront1.rotateAngleY = (float) 0.3 /*((LivingEntity) e).getPersistentData().getDouble("Wheel")*/;
			//	this.wellfront2.rotateAngleY = (float) 0.3 /*((LivingEntity) e).getPersistentData().getDouble("Wheel")*/;
			}
		}
	}
}
