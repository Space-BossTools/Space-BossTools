...
public class ModStructure {
    ...
    public static final Structure<VillageConfig> STRUCTURE = register(new ResourceLocation("boss_tools", "alien_village"), new AlienStructure(VillageConfig.field_236533_a_), GenerationStage.Decoration.SURFACE_STRUCTURES, new StructureSeparationSettings(25, 8, 1075254), false);
