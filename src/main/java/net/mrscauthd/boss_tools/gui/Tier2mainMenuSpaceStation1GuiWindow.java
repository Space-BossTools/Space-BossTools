...
@OnlyIn(Dist.CLIENT)
public class Tier2mainMenuSpaceStation1GuiWindow extends ContainerScreen<Tier2mainMenuSpaceStation1Gui.GuiContainerMod> {
	public static boolean Button1 = false;
	public static boolean Button2 = false;
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public Tier2mainMenuSpaceStation1GuiWindow(Tier2mainMenuSpaceStation1Gui.GuiContainerMod container, PlayerInventory inventory,
			ITextComponent text) {
	...
	public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > guiLeft + 52 && mouseX < guiLeft + 123 && mouseY > guiTop + 246 && mouseY < guiTop + 267) {
			...
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Temperature: \u00A73-270")); //hot c / cold 3 / is ok a
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 247, 70, 20, 0, 0, 0, Button1T, 70, 20, (p_2130901) -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier2mainMenuSpaceStation1Gui.ButtonPressedMessage(1, x, y, z));
			Tier2mainMenuSpaceStation1Gui.handleButtonAction(entity, 1, x, y, z);
		}));

		//Back Button
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 223, 70, 20, 0, 0, 0, Button2T, 70, 20, (p_2130901) -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier2mainMenuSpaceStation1Gui.ButtonPressedMessage(0, x, y, z));
			Tier2mainMenuSpaceStation1Gui.handleButtonAction(entity, 0, x, y, z);
		}));
