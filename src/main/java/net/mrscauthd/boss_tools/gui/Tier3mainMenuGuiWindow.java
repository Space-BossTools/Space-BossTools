...
@OnlyIn(Dist.CLIENT)
public class Tier3mainMenuGuiWindow extends ContainerScreen<Tier3mainMenuGui.GuiContainerMod> {
	...
	public Tier3mainMenuGuiWindow(Tier3mainMenuGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static ResourceLocation GreenButton2T = new ResourceLocation("boss_tools:textures/buttons/green_button.png");
	private static ResourceLocation GreenButton3T = new ResourceLocation("boss_tools:textures/buttons/green_button.png");
	private static ResourceLocation GreenButton4T = new ResourceLocation("boss_tools:textures/buttons/green_button.png");
	...
	public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > guiLeft + 52 && mouseX < guiLeft + 123 && mouseY > guiTop + 246 && mouseY < guiTop + 267) {
			...
			//ToolTip
			Category2.add(ITextComponent.getTextComponentOrEmpty("\u00A79Category: \u00A7aMars"));
		...
		if (mouseX > guiLeft + 52 && mouseX < guiLeft + 123 && mouseY > guiTop + 270 && mouseY < guiTop + 291) {
			Button3 = true;
			//ToolTip
			Category3.add(ITextComponent.getTextComponentOrEmpty("\u00A79Category: \u00A7aMercury"));
		...
		if (mouseX > guiLeft + 52 && mouseX < guiLeft + 123 && mouseY > guiTop + 294 && mouseY < guiTop + 315) {
			Button4 = true;
			//ToolTip
			Category4.add(ITextComponent.getTextComponentOrEmpty("\u00A79Category: \u00A7aVenus"));
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		if (Button2 == true) {
			GreenButton2T = new ResourceLocation("boss_tools:textures/buttons/green_button_2.png");
		} else {
			GreenButton2T = new ResourceLocation("boss_tools:textures/buttons/green_button.png");
		}

		if (Button3 == true) {
			GreenButton3T = new ResourceLocation("boss_tools:textures/buttons/green_button_2.png");
		} else {
			GreenButton3T = new ResourceLocation("boss_tools:textures/buttons/green_button.png");
		}

		if (Button4 == true) {
			GreenButton4T = new ResourceLocation("boss_tools:textures/buttons/green_button_2.png");
		} else {
			GreenButton4T = new ResourceLocation("boss_tools:textures/buttons/green_button.png");
		}

		//Button 1
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 223, 70, 20, 0, 0, 0, GreenButton1T, 70, 20,
				(p_2130901) -> {
					BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenuGui.ButtonPressedMessage(0, x, y, z));
					Tier3mainMenuGui.handleButtonAction(entity, 0, x, y, z);
				}));
		//Button 2
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 247, 70, 20, 0, 0, 0, GreenButton2T, 70, 20,
				(p_2130901) -> {
					BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenuGui.ButtonPressedMessage(1, x, y, z));
					Tier3mainMenuGui.handleButtonAction(entity, 1, x, y, z);
				}));
		//Button 3
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 271, 70, 20, 0, 0, 0, GreenButton3T, 70, 20,
				(p_2130901) -> {
					BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenuGui.ButtonPressedMessage(2, x, y, z));
					Tier3mainMenuGui.handleButtonAction(entity, 2, x, y, z);
				}));
		//Button 4
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 295, 70, 20, 0, 0, 0, GreenButton4T, 70, 20,
				(p_2130901) -> {
					BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenuGui.ButtonPressedMessage(3, x, y, z));
					Tier3mainMenuGui.handleButtonAction(entity, 3, x, y, z);
				}));
