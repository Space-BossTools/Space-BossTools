...
@OnlyIn(Dist.CLIENT)
public class Tier3mainMenu4GuiWindow extends ContainerScreen<Tier3mainMenu4Gui.GuiContainerMod> {
	...
	public Tier3mainMenu4GuiWindow(Tier3mainMenu4Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > guiLeft + 50 && mouseX < guiLeft + 121 && mouseY > guiTop + 245 && mouseY < guiTop + 266) {
			...
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Gravity: \u00A733.7 m/s"));
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Oxygen: \u00A7cfalse")); //false c / true a
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Temperature: \u00A7c427")); //hot c / cold 3
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.addButton(new ImageButton(this.guiLeft + 51, this.guiTop + 223, 70, 20, 0,0,0, Button7T, 70 , 20, e -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenu4Gui.ButtonPressedMessage(0, x, y, z));
			Tier3mainMenu4Gui.handleButtonAction(entity, 0, x, y, z);
		}));

		//Mercury Button
		this.addButton(new ImageButton(this.guiLeft + 51, this.guiTop + 246, 70, 20, 0,0,0,Button1T,70,20, e -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenu4Gui.ButtonPressedMessage(1, x, y, z));
			Tier3mainMenu4Gui.handleButtonAction(entity, 1, x, y, z);
		}));

		//Mercury Orbit Button
		this.addButton(new ImageButton(this.guiLeft + 126, this.guiTop + 246, 37, 20, 0,0,0, Button2T,37,20, e -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenu4Gui.ButtonPressedMessage(2, x, y, z));
			Tier3mainMenu4Gui.handleButtonAction(entity, 2, x, y, z);
		}));

		//Mercury Space Station Button
		this.addButton(new ImageButton(this.guiLeft + 168, this.guiTop + 246, 75, 20, 0,0,0, Button3T,75,20, e -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenu4Gui.ButtonPressedMessage(3, x, y, z));
			Tier3mainMenu4Gui.handleButtonAction(entity, 3, x, y, z);
		}));
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		//Mercury
		this.font.drawString(ms, " Mercury", 61, 252, -1);
