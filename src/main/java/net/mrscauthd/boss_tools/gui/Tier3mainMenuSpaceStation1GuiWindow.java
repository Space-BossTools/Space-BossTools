...
@OnlyIn(Dist.CLIENT)
public class Tier3mainMenuSpaceStation1GuiWindow extends ContainerScreen<Tier3mainMenuSpaceStation1Gui.GuiContainerMod> {
	public static boolean Button1 = false;
	public static boolean Button2 = false;
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public Tier3mainMenuSpaceStation1GuiWindow(Tier3mainMenuSpaceStation1Gui.GuiContainerMod container, PlayerInventory inventory,
			ITextComponent text) {
