...
public class CableGUIGui extends BossToolsModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("cable_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, CableGUIGuiWindow::new));
	}
		...
		if (buttonID == 0) {
			{
				...
				CableCheck1Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CableCheck2Procedure.executeProcedure($_dependencies);
			}
		}
	}
