...
import net.mrscauthd.boss_tools.procedures.SpaceStationCreateProcedure;
...
public class Tier1mainMenuSpaceStationGui extends BossToolsModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("tier_1main_menu_space_station"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, Tier1mainMenuSpaceStationGuiWindow::new));
	}
		...
		if (buttonID == 1) {
			{
				...
				SpaceStationCreateProcedure.executeProcedure($_dependencies);
			}
		}
	}
