...
import net.mrscauthd.boss_tools.procedures.OpenTier3SpaceStationMenu4Procedure;
...
public class Tier3mainMenu4Gui extends BossToolsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public Tier3mainMenu4Gui(BossToolsModElements instance) {
		super(instance, 654);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("tier_3main_menu_4"));
		}
	}
	@OnlyIn(Dist.CLIENT)
		...
		if (buttonID == 3) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				OpenTier3SpaceStationMenu4Procedure.executeProcedure($_dependencies);
			}
		}
	}
