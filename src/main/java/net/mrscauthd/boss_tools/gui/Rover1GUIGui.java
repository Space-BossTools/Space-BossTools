...
public class Rover1GUIGui extends BossToolsModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("rover_1_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
...
/* || new ItemStack(FuelBucketBigItem.block, (int) (1)).getItem() == stack.getItem()*/);
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 133, 16) {
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 115, 16) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 97, 16) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 151, 34) {
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 133, 34) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 115, 34) {
			}));
