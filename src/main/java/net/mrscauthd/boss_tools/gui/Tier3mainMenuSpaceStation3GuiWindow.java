...
@OnlyIn(Dist.CLIENT)
public class Tier3mainMenuSpaceStation3GuiWindow extends ContainerScreen<Tier3mainMenuSpaceStation3Gui.GuiContainerMod> {
	public static boolean Button1 = false;
	public static boolean Button2 = false;
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	public Tier3mainMenuSpaceStation3GuiWindow(Tier3mainMenuSpaceStation3Gui.GuiContainerMod container, PlayerInventory inventory,
			ITextComponent text) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 247, 70, 20, 0, 0, 0, Button1T, 70, 20, (p_2130901) -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenuSpaceStation3Gui.ButtonPressedMessage(1, x, y, z));
			Tier3mainMenuSpaceStation3Gui.handleButtonAction(entity, 1, x, y, z);
		}));

		//Back Button
		this.addButton(new ImageButton(this.guiLeft + 53, this.guiTop + 223, 70, 20, 0, 0, 0, Button2T, 70, 20, (p_2130901) -> {
			BossToolsMod.PACKET_HANDLER.sendToServer(new Tier3mainMenuSpaceStation3Gui.ButtonPressedMessage(0, x, y, z));
			Tier3mainMenuSpaceStation3Gui.handleButtonAction(entity, 0, x, y, z);
		}));
