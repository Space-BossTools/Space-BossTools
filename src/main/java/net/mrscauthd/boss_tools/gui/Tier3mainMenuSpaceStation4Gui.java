...
public class Tier3mainMenuSpaceStation4Gui extends BossToolsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public Tier3mainMenuSpaceStation4Gui(BossToolsModElements instance) {
		super(instance, 644);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("tier_3main_menu_space_station_4"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, Tier3mainMenuSpaceStation4GuiWindow::new));
	}
		...
		if (buttonID == 1) {
			{
				...
				Tier3SpaceStationCreate4Procedure.executeProcedure($_dependencies);
			}
		}
	}
