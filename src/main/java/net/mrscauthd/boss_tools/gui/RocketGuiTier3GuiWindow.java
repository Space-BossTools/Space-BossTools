...
public class RocketGuiTier3GuiWindow extends ContainerScreen<RocketGuiTier3Gui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 254, this.guiTop + 190, 36, 20, new StringTextComponent("Orbit"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 254, this.guiTop + 228, 36, 20, new StringTextComponent("Orbit"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 254, this.guiTop + 266, 36, 20, new StringTextComponent("Orbit"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 254, this.guiTop + 303, 36, 20, new StringTextComponent("Orbit"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 175, this.guiTop + 190, 75, 20, new StringTextComponent("Overworld"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 294, this.guiTop + 190, 79, 20, new StringTextComponent("Space Station"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 175, this.guiTop + 228, 75, 20, new StringTextComponent("Moon"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 294, this.guiTop + 228, 79, 20, new StringTextComponent("Space Station"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 175, this.guiTop + 266, 75, 20, new StringTextComponent("Mars"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 294, this.guiTop + 266, 79, 20, new StringTextComponent("Space Station"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 175, this.guiTop + 303, 75, 20, new StringTextComponent("Mercury"), e -> {
		...
		this.addButton(new Button(this.guiLeft + 294, this.guiTop + 303, 79, 20, new StringTextComponent("Space Station"), e -> {
