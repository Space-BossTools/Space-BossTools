...
@OnlyIn(Dist.CLIENT)
public class Tier2mainMenu3GuiWindow extends ContainerScreen<Tier2mainMenu3Gui.GuiContainerMod> {
	...
	public Tier2mainMenu3GuiWindow(Tier2mainMenu3Gui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	public void render(MatrixStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (mouseX > guiLeft + 50 && mouseX < guiLeft + 121 && mouseY > guiTop + 245 && mouseY < guiTop + 266) {
			...
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Gravity: \u00A733.721 m/s"));
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Oxygen: \u00A7cfalse")); //false c / true a
			Category1.add(ITextComponent.getTextComponentOrEmpty("\u00A79Temperature: \u00A73-63")); //hot c / cold 3
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		//Mars
		this.font.drawString(ms, "   Mars", 62, 252, -1);
