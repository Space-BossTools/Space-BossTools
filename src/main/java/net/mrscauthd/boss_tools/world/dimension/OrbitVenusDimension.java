...
public class OrbitVenusDimension extends BossToolsModElements.ModElement {
	public OrbitVenusDimension(BossToolsModElements instance) {
		super(instance, 409);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("boss_tools:orbit_venus"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
