...
public class VenusDimension extends BossToolsModElements.ModElement {
	public VenusDimension(BossToolsModElements instance) {
		super(instance, 396);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("boss_tools:venus"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
