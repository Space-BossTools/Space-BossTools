...
public class STStructures {
     ...
     */
    public static final RegistryObject<Structure<NoFeatureConfig>> RUN_DOWN_HOUSE = DEFERRED_REGISTRY_STRUCTURE.register("run_down_house", () -> (new AlienVillageStructure(NoFeatureConfig.field_236558_a_)));
