...
public class Rectangle2d {
	...
	@OnlyIn(Dist.CLIENT)
	public Rectangle2d(net.minecraft.client.renderer.Rectangle2d vanila) {
		this.x = vanila.getX();
		this.y = vanila.getY();
	...
	@OnlyIn(Dist.CLIENT)
	public net.minecraft.client.renderer.Rectangle2d toVanila() {
		return new net.minecraft.client.renderer.Rectangle2d(this.getX(), this.getY(), this.getWidth(), this.getHeight());
	}
}
