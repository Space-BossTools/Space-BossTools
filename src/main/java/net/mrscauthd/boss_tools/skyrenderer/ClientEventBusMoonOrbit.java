...
public class ClientEventBusMoonOrbit {
	...
	private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation("boss_tools", "moon_orbit");
	private static final ResourceLocation MOON_TEXTURE = new ResourceLocation("boss_tools", "textures/sky/moon.png");
