...
public class ClientEventBusMercuryOrbit {
	...
	private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation("boss_tools", "mercury_orbit");
	private static final ResourceLocation MERCURY_TEXTURE = new ResourceLocation("boss_tools", "textures/sky/mercury.png");
