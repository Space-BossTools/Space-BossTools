...
public class ClientEventBusMarsOrbit {
	...
	private static final ResourceLocation DIM_RENDER_INFO = new ResourceLocation("boss_tools", "mars_orbit");
	private static final ResourceLocation MARS_TEXTURE = new ResourceLocation("boss_tools", "textures/sky/mars.png");
