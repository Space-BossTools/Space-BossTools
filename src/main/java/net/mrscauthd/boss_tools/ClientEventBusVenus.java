...
public class ClientEventBusVenus {
    ...
    private static final ResourceLocation CLOUDS_TEXTURES = new ResourceLocation("boss_tools", "textures/sky/clouds.png");
    private static final ResourceLocation RAIN_TEXTURES = new ResourceLocation("boss_tools", "textures/sky/rain.png");
                    ...
                    public IWeatherRenderHandler getWeatherRenderHandler() {
                        return new IWeatherRenderHandler() {
                            ...
                            public void render(int ticks, float partialTicks, ClientWorld world, Minecraft mc, LightTexture lightmapIn, double xIn, double yIn, double zIn) {
                                ...
                                //Biome biome2 = world.getBiome(blockpos$mutable2);
                                //world.setRainStrength(biome2.getDownfall());
                                float f = Minecraft.getInstance().world.getRainStrength(partialTicks);
                                //System.out.println(world.getRainStrength(partialTicks));
                                if (!(f <= 0.0F)) {
                    ...
                    public ICloudRenderHandler getCloudRenderHandler() {
                        return new ICloudRenderHandler() {
                            ...
                            public void render(int ticks, float partialTicks, MatrixStack matrixStack, ClientWorld world, Minecraft mc,
                                ...
                                //          if (renderHandler != null) {
                                //             renderHandler.render(ticks, partialTicks, matrixStack, world, mc, viewEntityX, viewEntityY, viewEntityZ);
                                //             return;
                                //         }
